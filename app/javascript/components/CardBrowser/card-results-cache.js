...
export const getCachedCards = (hashParams) => (
  JSON.parse(window.sessionStorage.getItem(stringifyHash(hashParams)))
)

export const isCachedCards = (hashParams) => (
  window.sessionStorage.getItem(stringifyHash(hashParams)) !== null
)
